...
class FinalWin(QWidget):
    ...
    def results(self):
        ...
        if self.age >= 15:
            if self.index >= 15:
                score_text.setText(txt_workheart + txt_res1)
            elif self.index >= 11 and self.index <= 14.9:
                score_text.setText(txt_workheart + txt_res2)
            elif self.index >= 6 and self.index <= 10.9:
                score_text.setText(txt_workheart + txt_res3)
            elif self.index >= 0.5 and self.index <= 5.9:
                score_text.setText(txt_workheart + txt_res4)
            else:
                score_text.setText(txt_workheart+ txt_res5)
            ...
            if self.index >= 18:
                ...
                score_text.setText(txt_workheart+ txt9es5)
